...
public class GooiiPaymentRequest extends GooglePaymentRequest implements Parcelable {
     ...
     */
    public GooiiPaymentRequest transactionInfo(TransactionInfo transactionInfo) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest emailRequired(boolean emailRequired) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest phoneNumberRequired(boolean phoneNumberRequired) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest billingAddressRequired(boolean billingAddressRequired) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest billingAddressFormat(@WalletConstants.BillingAddressFormat int billingAddressFormat) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest shippingAddressRequired(boolean shippingAddressRequired) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest shippingAddressRequirements(ShippingAddressRequirements shippingAddressRequirements) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest allowPrepaidCards(boolean allowPrepaidCards) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest paypalEnabled(boolean enablePayPal) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest setAllowedPaymentMethod(String paymentMethodType, JSONObject parameters) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest setTokenizationSpecificationForType(String paymentMethodType, JSONObject parameters) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest setAllowedAuthMethods(String paymentMethodType, JSONArray authMethods) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest setAllowedCardNetworks(String paymentMethodType, JSONArray cardNetworks) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest googleMerchantId(String merchantId) {
     ...
     * @return {@link GooglePaymentRequest}
     */
    public GooiiPaymentRequest googleMerchantName(String merchantName) {
        mGoogleMerchantName = merchantName;
        return this;
    }

    public GooiiPaymentRequest environment(String environment) {
    ...
    protected GooiiPaymentRequest(Parcel in) {
    ...
    public static final Creator<GooglePaymentRequest> CREATOR = new Creator<GooglePaymentRequest>() {
        @Override
        public GooiiPaymentRequest createFromParcel(Parcel in) {
            return new GooiiPaymentRequest(in);
        }

        @Override
        public GooiiPaymentRequest[] newArray(int size) {
            return new GooiiPaymentRequest[size];
        }
    };
